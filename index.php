<html>
<head>
	<title>shabizhenghaowei</title>
	<style type="text/css">
		<?php include('css/main.css') ?>
	</style>
	<link rel="stylesheet" type="text/css" href="css/weather-icons.css">
	<link rel="stylesheet" type="text/css" href="css/font-awesome.css">
    <link rel="stylesheet" type="text/css" href="css/zj_banner.css">
...
<body>
    <div class="zj_banner">
        <div class="container">
            <div class="zj_fade"><img src="banner/1.jpg"></div>
            <div class="zj_fade"><img src="banner/2.jpg"></div>
            <div class="zj_fade"><img src="banner/3.jpg"></div>
        </div>
    </div>
...
<script src="js/zj_banner.js"></script>
